...
1. Fork `the repository <https://github.com/augmentedfabricationlab/bridgethegap_example>`_ and clone the fork.
...
When `reporting a bug <https://github.com/augmentedfabricationlab/bridgethegap_example/issues>`_
please include:
...
`Github <https://github.com/augmentedfabricationlab/bridgethegap_example/issues>`_. If you are proposing a feature:
